...
GameEngine::GameEngine() {
    ...
    auto defaultMappings = std::make_shared<Ship::ControllerDefaultMappings>(
        ...
        std::unordered_map<CONTROLLERBUTTONS_T, std::unordered_set<Ship::KbScancode>>{
            ...
            { KART_USE_ITEM_FORWARD_BUTTON, { Ship::KbScancode::LUS_KB_X} },
            { KART_USE_ITEM_BACKWARD_BUTTON, { Ship::KbScancode::LUS_KB_V} },
            { KART_MENU_CONFIRM_BUTTON, { Ship::KbScancode::LUS_KB_ENTER} },
            { KART_MENU_CANCEL_BUTTON, { Ship::KbScancode::LUS_KB_ESCAPE} },
            { KART_CLUTCH_BUTTON, { Ship::KbScancode::LUS_KB_C} },
            { KART_SHIFT_GEAR_1_BUTTON, { Ship::KbScancode::LUS_KB_1} },
            { KART_SHIFT_GEAR_2_BUTTON, { Ship::KbScancode::LUS_KB_2} },
            { KART_SHIFT_GEAR_3_BUTTON, { Ship::KbScancode::LUS_KB_3} },
            { KART_SHIFT_GEAR_4_BUTTON, { Ship::KbScancode::LUS_KB_4} },
            { KART_SHIFT_GEAR_5_BUTTON, { Ship::KbScancode::LUS_KB_5} },
            { KART_SHIFT_GEAR_6_BUTTON, { Ship::KbScancode::LUS_KB_6} },
            { KART_SHIFT_REVERSE_BUTTON, { Ship::KbScancode::LUS_KB_7} },
            { KART_SHIFT_NEUTRAL_BUTTON, { Ship::KbScancode::LUS_KB_0} },
            { KART_TOGGLE_MUSIC_BUTTON, { Ship::KbScancode::LUS_KB_M} },
    ...
    auto buttonNames = std::unordered_map<CONTROLLERBUTTONS_T, std::string>({
                      ...
                      { BTN_R, "Drift" },
                      { BTN_Z, "Use Item" },
                      { KART_USE_ITEM_FORWARD_BUTTON, "Use Item Forward" },
                      { KART_USE_ITEM_BACKWARD_BUTTON, "Use Item Backward" },
                      { KART_MENU_CONFIRM_BUTTON, "Menu Confirm" },
                      { KART_MENU_CANCEL_BUTTON, "Menu Cancel" },
                      { KART_CLUTCH_BUTTON, "Clutch" },
                      { KART_SHIFT_GEAR_1_BUTTON, "Shift Gear 1" },
                      { KART_SHIFT_GEAR_2_BUTTON, "Shift Gear 2" },
                      { KART_SHIFT_GEAR_3_BUTTON, "Shift Gear 3" },
                      { KART_SHIFT_GEAR_4_BUTTON, "Shift Gear 4" },
                      { KART_SHIFT_GEAR_5_BUTTON, "Shift Gear 5" },
